...
class TravelAdviceAtomTest < ActionDispatch::IntegrationTest
  ...
  context "aggregate feed" do
    should "display the list of countries as an atom feed" do
      ...
      assert page.has_xpath? ".//feed/entry[1]/id", text: "http://www.test.gov.uk/foreign-travel-advice/sao-tome-and-principe#2015-12-08T17:02:23+00:00"
      assert page.has_xpath? ".//feed/entry[1]/link[@type='text/html' and @href='http://www.test.gov.uk/foreign-travel-advice/sao-tome-and-principe']"
      assert page.has_xpath? ".//feed/entry[1]/link[@type='application/atom+xml' and @href='http://www.test.gov.uk/foreign-travel-advice/sao-tome-and-principe.atom']"
      ...
      assert page.has_xpath? ".//feed/entry[2]/id", text: "http://www.test.gov.uk/foreign-travel-advice/spain#2015-01-06T00:00:00+00:00"
      assert page.has_xpath? ".//feed/entry[2]/link[@type='text/html' and @href='http://www.test.gov.uk/foreign-travel-advice/spain']"
      assert page.has_xpath? ".//feed/entry[2]/link[@type='application/atom+xml' and @href='http://www.test.gov.uk/foreign-travel-advice/spain.atom']"
